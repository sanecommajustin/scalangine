...
object Game3 extends BasicGameRunner {
  ...
  override def draw: Unit = {
    ...
    Shapes.drawRectangle(Rectangle(0, 0, 800, 600), Color.BLACK)
    Shapes.drawRectangle(Rectangle(10, 10, 50, 50), Color.ORANGE)
    Shapes.drawTriangle(Triangle((200, 200),(200, 250), (250, 250)) , Color.PURPLE)
  }
}